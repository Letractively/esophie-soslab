...
<p><a href="http://webdev.sophiemartin.com/sos/mbrpaymentconfirm.php?pageaction=simulate&salesid=<?=$ctrl->varvalue('salesid')?>&vanumber=<?=$ctrl->varvalue('virtualaccount')?>">Payment init</a></p>
<? } ?>
