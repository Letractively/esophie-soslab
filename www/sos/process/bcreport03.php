	...
	{			
		...
		function loaddata() 
		{
			...
			if (isset($this->param["search_paiddate_from"]) && trim($this->param["search_paiddate_from"]) != "")
				$sql.= " and paiddate >= " . $this->querydatevalue($this->param["search_paiddate_from"]);
			if (isset($this->param["search_paiddate_from"]) && trim($this->param["search_paiddate_to"]) != "")
				$sql.= " and paiddate >= " . $this->querydatevalue($this->param["search_paiddate_to"]);
