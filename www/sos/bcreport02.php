...
<div class="boxcon4">
<div class="title">Online Orders History</div>
...
<table class="dataview">
	<tr>
		...
		<th width="110" align="right"><a href="#" class="colname" onclick="setaction('sortby_totalbayar');">Total Bayar Member<?=$ctrl->sortimage('totalbayar')?></a></th>
	...
	{
		echo '<td colspan="7" align="center">no items</td>';
	}
?>
</table>
</div>
